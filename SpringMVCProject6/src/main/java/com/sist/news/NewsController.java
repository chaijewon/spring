	...
	public void rGraph()
	   {
		   try
		   {
			   ...
			   rc.voidEval("png(\"C:/springDev/springStudy/.metadata/.plugins/org.eclipse.wst.server.core/tmp0/wtpwebapps/SpringMVCProject6/main/news.png\")");
			   rc.voidEval("data<-readLines(\"c:/data/never.txt\")");
